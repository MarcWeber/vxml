...
showGeneratedCode = False -- if you are curious enable this to see the code beeing generated by template haskell
debugStateCount = True
debugStates = False -- enable this to have a look at the state reduction instances
mytrace _ a = a
